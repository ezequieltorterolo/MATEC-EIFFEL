    ...
    <div class="cont-menu">
        ...
        <div class="cont-opciones-header">
            <?php if (isset($_SESSION["usuario"])): ?>
                <div class="cont-sesion-nombre-y-foto"><img class="icono-alternativo-logueado"  src="img/avatar-user-relleno.svg" style="width:35px; height:35px;">
                    <p><?= $_SESSION["usuario"]["nombre"] ?></p>
                    <div class="cont-cerrar-sesion">
                        <a onclick="cerrarSesion(<?= $_SESSION['usuario']['id'] ?>)">
                            <p>Cerrar sesion</p>
                        </a>
                    </div>
                </div>
            <?php else: ?>
                <img class="icono-principal" src="img/avatar-user.svg" style="width:35px; height:35px;"> <a href="/login"><img class="icono-alternativo"  src="img/avatar-user-relleno.svg" style="width:35px; height:35px;"></a>
            <?php endif ?>
            <a href="carrito"> <img class="icono-principal" src="img/carrito.svg" style="width:35px; height:35px;"><img class="icono-alternativo" src="img/carrito-relleno.svg" style="width:35px; height:35px;">
