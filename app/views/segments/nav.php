    ...
    <div class="iconos" style="display:none;">
      <div class="derecha"> 
        ...
        <button>
          ...
          <div id="badge-carrito" class="badge bg-danger" style="position: relative; right: 15px; bottom: 10px;"> <p id="carr-cantidad"> </p><!-- Aqui esta la badge de carrito en la vista movil-->
                </div>
                </a>
        </button>
